...
db.exec(`
  ...
  INSERT OR IGNORE INTO courses (id, title, description, teacher_id, start_date, end_date) VALUES 
  (1, 'Introducción a la LSE', 'Aprende los fundamentos básicos de la Lengua de Señas Española. Saludos, abecedario y expresiones comunes.', 2, '2024-03-01', '2024-04-01');
  
  INSERT OR IGNORE INTO courses (id, title, description, teacher_id, start_date, end_date) VALUES 
  (2, 'LSE Nivel Intermedio', 'Profundiza en la gramática y vocabulario avanzado. Ideal para quienes ya conocen lo básico.', 2, '2024-03-15', '2024-05-15');

  INSERT OR IGNORE INTO courses (id, title, description, teacher_id, start_date, end_date) VALUES 
  (3, 'Cultura Sorda y Comunidad', 'Un viaje por la historia, valores y cultura de la comunidad sorda en el mundo.', 1, '2024-04-01', '2024-05-01');
